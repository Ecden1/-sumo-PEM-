...
#一开始想做和Yolo配合实时更新的，后来不了了之了
# 1. 配置路径
CSV_PATH = Path(r"C:\Users\60322\Desktop\Single_Sensor_Time_Series.csv")  # 你的CSV路径
SUMO_NET_PATH = Path(r"C:\Users\60322\Desktop\PEM实践\nets\2way-single-intersection\single-intersection.net.xml.xml") # 你的SUMO路网文件路径
SUMO_ROU_PATH = Path(r"C:\Users\60322\Desktop\PEM实践\nets\2way-single-intersection\auto_generated.rou.xml")  # 上面修改的车流文件
